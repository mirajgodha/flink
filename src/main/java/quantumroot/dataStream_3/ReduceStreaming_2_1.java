...
public class ReduceStreaming_2_1 {
    public static void main(String[] args) throws Exception {
        ...
        if (!params.has("input")) {
            throw new Exception("No input path provided. Provide input as --input <inputPath to avg file>");
        }
        ...
        profitPerMonth.writeAsText(params.get("output"));
    ...
    /**
     * Reduces the input tuple by summing up the profit and count for each month
     * If current month is June, then add the profit and count of current tuple to the pre_result tuple
     */
    ...
    /**
     * Splits the input string into a tuple of (month, category, product, profit, count)
     */
